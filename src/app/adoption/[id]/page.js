...
export default async function DogProfile({ params }) {
  ...
  if (error || !dog) {
    ...
    <div className="flex flex-col min-h-screen relative">
      ...
      <main className="grow py-10 flex items-center justify-center px-4 bg-transparent">
        <div className="w-full max-w-sm bg-white/80 backdrop-blur-md rounded-[50px] shadow-2xl overflow-hidden border border-white/50">
          ...
          <DogImageGallery photos={dog.photos} dogName={dog.name} />

          <div className="px-6 pb-12 flex flex-col items-center gap-y-2">
              <div className="-mt-12 mb-12 py-4 px-12 rounded-2xl shadow-xl text-3xl font-black text-white uppercase tracking-tighter relative z-10"
              ...
              <div className="w-full p-6 rounded-[25px] mb-12 text-white shadow-lg" style={{ backgroundColor: '#C89B6A' }}>
                  ...
                  <p className="text-xs font-medium leading-relaxed opacity-95">
                    {dog.traits || 'Healthy, energetic, and full of life, I’m a playful pup looking for a loving home to call my own. I’m ready to grow, learn, and fill your days with wagging tails and endless loyalty. If you’re looking for a lifetime of adventure and snuggles, I’m the one for you!'}
                  </p>
              </div>
              ...
              <div className="w-full flex flex-col gap-6 mb-14">
                  ...
                  <DetailRow label="FAV FOOD" value={dog.favorite_food || 'Not specified'} />
              </div>
